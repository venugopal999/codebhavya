(() => {
    ...
    window.CBConceptViz = {
        ...
        next(id) {
            ...
            if (!s || s.index >= s.frames.length - 1)
                return;
...
/* ============================================================
   SHOW ANSWER
   Used for Practice Questions and Interview Questions
   ============================================================ */
...
/* ============================================================
   ...
   SOLVE IT YOURSELF / HINT / SHOW PROGRAM / RUN CODE
   ============================================================ */
...
/* ============================================================
   GENERIC C TOPIC PRACTICE SUPPORT

   This allows Structure, Variables, Data Types,
   Operators, Loops, Arrays and other C topic pages
   to reuse the same practice system.
   ============================================================ */
