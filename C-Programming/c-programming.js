...
window.CBMCQ = {
    ...
    check(id) {
        ...
        /* A focused lesson check may provide a misconception-specific reason
           on each option. Existing MCQs without this attribute keep their
           current behaviour. */
        const selectedOption =
            selected.closest(".cb-mcq-option");
        ...
        if (selectedRationale) {
            const explanation =
                selectedOption?.dataset.explanation || "";

            selectedRationale.textContent = explanation;
            selectedRationale.hidden = !explanation;
        }
