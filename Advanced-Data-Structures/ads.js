(function () {
    ...
    const topicCards =
        Array.from(document.querySelectorAll(".topic-card"));

    const sidebarLinks =
        Array.from(document.querySelectorAll(".ads-topic-link"));

    const levelSections =
        Array.from(document.querySelectorAll(".ads-level-section"));

    const noResults =
        document.getElementById("noTopicResults");
    ...
    /*
     * Keep undeveloped ADS topics disabled.
     * Remove this section for a link after that topic
