...
The catalog contains **898 unique, compiler-ready programs** across six
courses: 200 C Programming examples, 106 Data Structures examples, 112
Advanced Data Structures examples, 150 Python examples, 130 AI & Machine
Learning examples and 200 Java examples. Programs are grouped into 96 compact topic accordions on a
...
The Java library progresses from Java 17 syntax, input/output, types, decisions,
loops, arrays, strings and methods through OOP, inheritance, abstraction,
exceptions, collections, files, concurrency, streams, algorithms and complete
placement-oriented mini projects. See `JAVA-CONCEPT-COVERAGE.md` for the
audited level map.
...
- Java coverage checklist: `JAVA-CONCEPT-COVERAGE.md`
...
- Generated Java sources: `java-source/`
...
sources with Python 3; compiles all 200 Java sources with Java 17; then executes
every sample with a timeout and confirms its expected output.
