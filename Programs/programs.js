...
(function () {
  ...
  // The complete C library fits comfortably as collapsed topic accordions.
  // Keeping all results on one page prevents a topic from being split across
  // multiple pages while still showing only one expanded section at a time.
  const pageSize = 200;
