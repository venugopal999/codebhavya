(function () {
    ...
    const STORAGE_KEY = "codebhavya.python.level7.practice.v1";
    ...
    const problems = {
        "collections-p1": {
            ...
            inputs: ["Java"],
            expected: "Courses = ['Python', 'C', 'Java']"
        },
        "collections-p2": {
            starter: [
                ...
                "total = 0",
                "highest = 0",
                "# Calculate the total and highest mark",
                "print(\"Total =\", total)",
        ...
        "collections-p3": {
            starter: [
                ...
                "name = \"?\"",
                "score = 0",
                "# Unpack the tuple into name and score",
                "print(\"Name =\", name)",
                "print(\"Score =\", score)"
            ].join("\n"),
            inputs: ["Bhavya", "92"],
        ...
        "collections-p4": {
            starter: [
                "numbers = [2, 4, 2, 6, 4]",
                "unique = numbers",
                "# Remove duplicates and display sorted values",
                "print(\"Unique =\", unique)"
            ].join("\n"),
            inputs: [],
            expected: "Unique = [2, 4, 6]"
        },
        "collections-p5": {
            starter: [
                "team_a = {\"Python\", \"SQL\", \"C\"}",
                ...
                "common = set()",
                "# Find and sort the shared skills",
                "print(\"Common =\", common)"
            ].join("\n"),
            inputs: [],
            expected: "Common = ['Python', 'SQL']"
        }
    };
        ...
        quiz.querySelector(
            ...
            questions.forEach(function (question) {
                ...
                feedback.textContent = correct
                    ...
                    : (
                        selected
                            ? "✕ Review the collection rule and try again."
            ...
            if (answered < questions.length) {
                ...
                result.textContent =
                    ...
                    "/" +
                    questions.length +
                    " — your collection concepts are clear.";
            } else if (
                score >=
                ...
                result.textContent =
                    ...
                    "/" +
                    questions.length +
                    " — revise lists, tuples and sets, then try again.";
            }
        });
    ...
    function displayValue(value) {
        ...
        if (isTuple(value)) {
            const content = value.values.map(
                displayCollectionItem
            ).join(", ");
    ...
    function parseCollectionLiteral(
        ...
        if (
            ...
            return splitArguments(inside).map(
                function (part) {
    ...
    function collectionContains(
        ...
        return valuesOf(collection).some(
            function (value) {
    ...
    function initializeVisualizer() {
        ...
        const frames = [
            ...
            },
            {
                title:
                    "2. Append Java",
                detail:
                    "append('Java') adds one new element at the end: ['Python', 'C', 'Java']."
            },
            {
                title:
                    "3. Update Index 0",
                detail:
                    "Assignment replaces the first element with 'SQL': ['SQL', 'C', 'Java']."
            },
            {
                title:
                    "4. Remove C",
                detail:
                    "remove('C') deletes the first matching element: ['SQL', 'Java']."
            },
            {
                title:
                    "5. Inspect the Final List",
                detail:
                    "The same mutable list now contains two values in order: ['SQL', 'Java']."
            }
        ];
        ...
        const stepText =
            document.getElementById(
                "pythonCollectionVisualStep"
            );
        const title =
            document.getElementById(
                "pythonCollectionVisualTitle"
            );
        const detail =
            document.getElementById(
                "pythonCollectionVisualDetail"
            );
        const dots =
            document.getElementById(
                "pythonCollectionVisualDots"
            );
        const progress =
            document.getElementById(
                "pythonCollectionVisualProgress"
            );
        ...
        const frames = [
            {
                ...
                output: "",
                note:
                    "Create a list containing three marks."
            },
            {
                line: 1,
                state: {
            ...
            },
            {
                ...
                output: "",
                note:
                    "First iteration: add 78, so total becomes 78."
            },
            {
                line: 3,
                state: {
                ...
                output: "",
                note:
                    "Second iteration: add 85, so total becomes 163."
            },
            {
                line: 3,
                state: {
                ...
                output: "",
                note:
                    "Third iteration: add 92, so total becomes 255."
            },
            {
                line: 4,
                state: {
                ...
                output: "Total = 255",
                note:
                    "Display the completed total. Program execution is complete."
            }
        ];

        const code =
            document.getElementById(
                "pythonCollectionTraceCode"
            );
        const note =
            document.getElementById(
                "pythonCollectionTraceNote"
            );
        const live =
            document.getElementById(
                "pythonCollectionTraceState"
            );
        const output =
            document.getElementById(
                "pythonCollectionTraceOutput"
            );
        const status =
            document.getElementById(
                "pythonCollectionTraceStatus"
            );
    ...
    window.CodeBhavyaCollectionRunner =
        runCollectionCode;
