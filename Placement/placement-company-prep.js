(function () {
    ...
    function selectedTopic() { return ["c", "python", "dsa", "database", "ai-ml"].includes($("companyTopic").value) ? $("companyTopic").value : "c"; }
    function selectedTopicLabel() { return { c: "C", python: "Python", dsa: "DSA", database: "SQL", "ai-ml": "AI & ML" }[selectedTopic()]; }
