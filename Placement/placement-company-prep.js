(function () {
    ...
    function selectedTopic() { return ["c", "python", "dsa"].includes($("companyTopic").value) ? $("companyTopic").value : "c"; }
    function selectedTopicLabel() { return selectedTopic() === "python" ? "Python" : selectedTopic() === "dsa" ? "DSA" : "C"; }
