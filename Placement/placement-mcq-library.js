(function () {
    ...
    function initialize() {
        ...
        $("revisionCodingLink").href = hasCodingArena ? `coding.html?topic=${encodeURIComponent(topic)}` : `practice.html#${encodeURIComponent(topic)}-practice`;
        $("revisionCodingLink").hidden = !hasCodingArena;
        if (topic === "database") $("revisionCodingLink").textContent = "Practise SQL queries";
        $("revisionNavCoding").href = hasCodingArena ? `coding.html?topic=${encodeURIComponent(topic)}` : `practice.html#${encodeURIComponent(topic)}-practice`;
        $("revisionNavCoding").textContent = topic === "database" ? "SQL Arena" : topic === "ai-ml" ? "AI/ML Lab" : hasCodingArena ? "Coding Arena" : "Practice Hub";
