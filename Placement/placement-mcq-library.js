(function () {
    ...
    function initialize() {
        ...
        const hasCodingArena = ["c", "python", "dsa", "database"].includes(topic);
        ...
        $("revisionNavCoding").textContent = topic === "database" ? "SQL Arena" : hasCodingArena ? "Coding Arena" : "Practice Hub";
