(function () {
    ...
    function initialize() {
        ...
        $("revisionCodingLink").href = hasCodingArena ? `coding.html?topic=${encodeURIComponent(topic)}` : `practice.html#database-practice`;
        $("revisionCodingLink").hidden = !hasCodingArena;
        if (topic === "database") $("revisionCodingLink").textContent = "Practise SQL queries";
        $("revisionNavCoding").href = hasCodingArena ? `coding.html?topic=${encodeURIComponent(topic)}` : `practice.html#database-practice`;
