(function () {
    ...
    function calculateReview() {
        ...
        if (evidenceScore <= 2) {
            ...
            $("reviewBand").textContent = "INTERVIEW-READY EVIDENCE";
            $("reviewTitle").textContent = "Clear, relevant and defensible.";
            $("reviewMessage").textContent = "All five evidence checks are present. Compare the model points and follow-ups, then complete the review.";
        }
