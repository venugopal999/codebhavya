(function () {
    ...
    function setMode(value) {
        const selected = value === "track" ? "track" : "topic";
    ...
    function currentFocus() {
        return mode() === "topic"
            ? (topicLabels[$("libraryTopic").value] || "Selected C topic")
            : (targetLabels[$("libraryTrack").value] || "Selected preparation track");
    }
    ...
    function problemUrl(problem) {
        ...
        else query.set("track", $("libraryTrack").value);
    ...
    function renderProblems() {
        ...
        visible.forEach((problem) => {
            ...
            metadata.append(
                ...
                makeTag(targetLabels[problem.target_path] || "General Campus Placement")
            );
    ...
    async function loadProblems(event) {
        ...
        try {
            let query = client.from("coding_problems")
                .select("id,slug,title,topic,topic_group,subtopic,problem_type,skill_tags,difficulty,target_path,statement,points")
    ...
    async function initialize() {
        ...
        [$("libraryTopic"), $("libraryTrack"), $("libraryDifficulty")].forEach((control) => {
        ...
        const requestedMode = parameters.get("mode") === "track" ? "track" : "topic";
