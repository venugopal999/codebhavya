(function () {
    ...
    const targetLabels = {
        ...
        product: topic === "database" ? "Product Engineering & Advanced SQL" : "Product Engineering & DSA",
    ...
    async function initialize() {
        ...
        $("libraryBreadcrumb").textContent = topic === "database" ? "SQL Problem Library" : `${topicLabel} Problem Library`;
        $("libraryEyebrow").textContent = `100-PROBLEM ${topic === "database" ? "SQL" : topicLabel.toUpperCase()} MASTERY PATH`;
        $("libraryHeading").textContent = topic === "database" ? "SQL Problem Library" : `${topicLabel} Problem Library`;
