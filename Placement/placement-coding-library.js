(function () {
    ...
    function renderProblems() {
        ...
        visible.forEach((problem) => {
            ...
            tags.append(
                ...
                makeTag(problem.subtopic || `${topicLabel} programming`, "topic-tag")
            );
    ...
    async function initialize() {
        ...
        $("libraryBreadcrumb").textContent = `${topicLabel} Problem Library`;
        $("libraryEyebrow").textContent = `100-PROBLEM ${topicLabel.toUpperCase()} MASTERY PATH`;
        $("libraryHeading").textContent = `${topicLabel} Problem Library`;
