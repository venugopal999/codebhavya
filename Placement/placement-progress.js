(function () {
    ...
    const codingToSkill = topic === "python" ? pythonCodingToSkill : topic === "dsa" ? dsaCodingToSkill : cCodingToSkill;
    const skillToMcq = topic === "python" ? identityMap : topic === "dsa" ? dsaIdentityMap : cSkillToMcq;
    const skillToCoding = topic === "python" ? pythonSkillToCoding : topic === "dsa" ? dsaSkillToCoding : cSkillToCoding;
    ...
    function renderSummary(data) {
        ...
        $("codingSolvedNote").textContent = number(summary.total_problems) === 0
            ? `Install the ${topicLabel} coding seed to enable this evidence`
    ...
    function initialize() {
        ...
        if ($("progressProblemLink")) $("progressProblemLink").href = `coding.html?topic=${topic}`;
        ...
        if ($("navCoding")) $("navCoding").href = `coding.html?topic=${topic}`;
