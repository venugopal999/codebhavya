(function () {
    ...
    const topic = parameters.get("topic") === "python" ? "python" : "c";
    const topicLabel = topic === "python" ? "Python" : "C";
    ...
    const mcqLabels = topic === "python" ? pythonLabels : cMcqLabels;
    const codingLabels = topic === "python" ? pythonLabels : cCodingLabels;
    const skillOrder = topic === "python" ? pythonOrder : cSkillOrder;
    const skillLabels = topic === "python" ? pythonLabels : cSkillLabels;
    const codingToSkill = topic === "python" ? pythonCodingToSkill : cCodingToSkill;
    const skillToMcq = topic === "python" ? identityMap : cSkillToMcq;
    const skillToCoding = topic === "python" ? pythonSkillToCoding : cSkillToCoding;
