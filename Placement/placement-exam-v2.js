(function () {
    ...
    async function initialize() {
        ...
        $("resultCodingLink").textContent = topic === "database" ? "Open SQL Problem Library →" : hasCodingArena ? `Open ${topicLabel} Problem Library →` : `View ${topicLabel} Progress →`;
        $("resultCodingLink").hidden = false;
        $("quizNavCoding").href = hasCodingArena ? `coding.html?topic=${encodeURIComponent(topic)}` : "practice.html#database-practice";
        $("quizNavCoding").textContent = topic === "database" ? "SQL Arena" : hasCodingArena ? "Coding Arena" : "Practice Hub";
