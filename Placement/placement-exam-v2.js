(function () {
    ...
    async function initialize() {
        ...
        $("resultCodingLink").textContent = hasCodingArena ? `Open ${topicLabel} Problem Library →` : "View Database & SQL Progress →";
        ...
        $("quizNavCoding").textContent = hasCodingArena ? "Coding Arena" : "Practice Hub";
