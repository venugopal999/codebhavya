...
`,
  ...
  function inputKey(language) {
    return `codebhavya-compiler:${language}:stdin`;
  }
  ...
  function scheduleSave() {
    ...
    saveTimer = window.setTimeout(() => {
      ...
      const inputSaved = writeStored(inputKey(currentLanguage), elements.stdin.value);

      if (elements.saveState) {
        elements.saveState.lastChild.textContent = sourceSaved && inputSaved
  ...
  function saveImmediately() {
    ...
    writeStored(inputKey(currentLanguage), elements.stdin.value);
  }
  ...
  function resetCode() {
    ...
    writeStored(inputKey(currentLanguage), config.input);
    clearOutput();
  ...
  function bindEvents() {
    ...
    elements.stdin.addEventListener("input", scheduleSave);
